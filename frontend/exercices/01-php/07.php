	...
	<?php
		if(isset($_POST["register"])) {
			...
			echo "<table>
				...
				foreach ($products as $cod => $v) echo "
				<tr>
					<td>$cod</td>
					<td>$v[1]</td>
					<td>$v[0]</td>
			...
			echo "<p>Total Income from Stock is: $sumed</p>";
			...
			if(array_key_exists($searchcode, $products)) {
				echo "<p>
					...
					<br/>
					In Stock: ", $products[$searchcode][0],"
					<br/>
					Price: ", $products[$searchcode][1],"
				</p>";
			}

			else echo "<p>The inputed code doesn't exist!!!</p>";
		}
	?>
</body>
</html>