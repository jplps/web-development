...
<body>
	...
	<form id="form" action="06-arrays.php" method="post">
		<fieldset>
		...
		if(isset($_POST["send"])) { //Após submit setado como true (function "is set"), executar código;
			...
			//Ordenação de alunos inversamente (de Z para A):
				...
				echo "<table>
					...
					foreach ($students as $student => $grade) echo "<tr>
							<td>$student</td>
							<td>$grade</td>
					</tr>";
				...
				if ($exists) {
					$grade = $students[$student];
					echo "<p>$student EXISTS, and the grade is $grade/10.0!</p>";
				}

				else echo "<p>$student DON'T EXIST!</p>";
			}
				...
				echo "<p>The general Average is $mediaded/10.0!</p>";
			}
				...
				echo "<p>$aux students are Above the Average.</p>";
			}
				...
				echo "<p>Lowest $lg/10.0 belongs to $student.</p>";
			}
